			...
			switch (option) {
				...
				case 2:
					try {
						...
						} catch (GradesExceedException e) {
							System.out.println("Is not possible to unenroll the student with id " + id);
							System.out.println(e.getMessage());
						}
					} catch (NoExistStudentsException e) {
						System.out.println(e.getMessage());
					}
					break;
				case 3:
					try {
						...
						try {
							...
							System.out.println("Is not possible to set the grade to the student with the id " + id);
							System.out.println(e.getMessage());
						}
					} catch (NoExistStudentsException e) {
						System.out.println(e.getMessage());
